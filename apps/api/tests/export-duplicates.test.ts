...
import { buildExportItem } from "../src/export/civisight.js";
...
describe("entity mapping", () => {
  it("exact matches county names", () => {
    ...
    expect(match?.entity.id).toBe("civisight-entity-troup");
...
describe("export contract", () => {
  it("exports a valid CiviSight payload from an approved candidate", () => {
    const item = buildExportItem({
      id: "cand-1",
      title: "Submit FY2026 report",
      description: "Extracted summary",
      county_id: "civisight-entity-troup",
      deadline: "2026-09-30T23:59:59.000Z",
    ...
    expect(item.task.countyId).toBe("civisight-entity-troup");
